...
const AddQuestions = ({ exams, questions, handleDialogueOpen }: AddQuestionsFormProps) => {
  ...
  const handleQuestionDelete = (questions: QuestionsT) => {
    setIsLoading(true);
    const imageKey = questions.imageFile.substring(questions.imageFile.lastIndexOf("/" + 1));
