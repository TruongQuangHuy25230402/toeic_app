...
const AddPart2 = ({ exam, part2, handleDialogueOpen }: AddPart2FormProps) => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    if (exam && part2) {
      axios
        .patch(`/api/part2/${part2.id}`, values)
        .then((res) => {
          toast({
            variant: "default",
      ...
      axios
        ...
        .post("/api/part2", { ...values, examId: exam.id })
        .then((res) => {
          toast({
            variant: "default",
          ...
          <div className="pt-4 pb-2 flex gap-2">
            {part2 ? (
              <>
                ...
                <Button
                  onClick={() => handleQuestionDelete(part2)}
                  type="button"
