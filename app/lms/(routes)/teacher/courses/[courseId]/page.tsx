...
import { ObjectId } from "mongodb"; // Import MongoDB ObjectId validation utility
...
const CourseIdPage = async ({ params }: { params: { courseId: string } }) => {
  ...
  if (!ObjectId.isValid(params.courseId)) {
    return redirect("/"); // Redirect if the courseId is not valid
  }
  ...
  return (
    ...
    {!course.isPublished && (
      <Banner 
      label="this course is unpublished. This will not be visible to the students"
      />
    )}
    <div className="p-6 ">
