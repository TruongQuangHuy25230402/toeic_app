        ...
        <div className="grid lg:grid-cols-2 grid-cols-1">
          <div className="lg:mb-0 mb-10">
            <div className="group w-full h-full">
              ...
              <img
  src="https://images.pexels.com/photos/1419924/pexels-photo-1419924.jpeg"
  alt="ContactUs tailwind section"
  className="w-full h-full lg:rounded-l-2xl rounded-2xl object-cover object-center bg-blend-multiply bg-indigo-700"
                ...
                <div className="absolute bottom-0 w-full lg:p-11 p-5">
                  <div className="bg-white rounded-lg p-6 block">
                    <a href="javascript:;" className="flex items-center mb-6">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">0789-698-980</h5>
                    </a>
                    <a href="javascript:;" className="flex items-center mb-6">
                      <svg width={30} height={30} viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">quanghuy200223@gmail.com</h5>
                    </a>
                    <a href="javascript:;" className="flex items-center">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">12 Nguyen Van Bao, Quan Go Vap, TP-HCM</h5>
                    </a>
                  </div>
                </div>
              </div>
